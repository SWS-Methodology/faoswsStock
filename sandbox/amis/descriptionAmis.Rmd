...
A linear regression was fitted excluding the regions **World** and **China** and **China** **Mainland**. The region was divided in: USA, EU and others countries. The items fitted were **Total** **Cereals** and **Soybeans**.


* Dependent variable: closing stocks 
* Independent variable: total supply, region and the type of commodity.
